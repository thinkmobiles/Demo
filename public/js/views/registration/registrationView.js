    ...
    var View = Backbone.View.extend({
        ...
        register: function (e) {
            ...
            if (!validation.validLength(self.$el.find(".registration .organization").val(), 2, 30)) {
                ...
                isError = true;
            }else if (!validation.validOrg(self.$el.find(".registration .organization").val())) {
            ...
            $.ajax({
                ...
                success: function (model) {
                    ...
                    //
                    //ToDo: Production
                    window.location = 'https://account.mooloop.com/oauth/authorize?response_type=code&client_id=S2aUNWlBd2HRMKsQzZqW&redirect_uri=http://projects.thinkmobiles.com:8838/redirect&scope=jumplead.contacts,jumplead.personal';
                },
                error: function (err) {
                    console.log(err);
