        ...
        register: function (e) {
            ...
            $.ajax({
                ...
                success: function (model) {
                    console.log(model);
                    //ToDo: Develop
                    window.location = 'https://account.mooloop.com/oauth/authorize?response_type=code&client_id=FcDOCBsnZ2TtKbHTGULY&redirect_uri=http://projects.thinkmobiles.com:8838/redirect&scope=jumplead.contacts,jumplead.personal';
